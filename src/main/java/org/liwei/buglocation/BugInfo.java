...
public class BugInfo {
	...
	public static void main(String[] args) {
		List<BugInfo> bugInfoList = getBugInfoFromExcel("/Users/liwei/Documents/defect-prediction/bug-report/dataset/JDT.xlsx");
		String destPath = "/Users/liwei/Documents/defect-prediction/working/summary_description.txt";
		...
		try {
			FileManage.writeStringToFile(summ_Desc, destPath);
		} catch (Exception e) {
			e.printStackTrace();
		}
